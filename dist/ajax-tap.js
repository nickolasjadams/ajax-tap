        ...
        window.fetch = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
          ...
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              case 0:
                fetchResponse = originalFetch.apply(this, _args);
                responseClone = fetchResponse.then(function (response) {
                  ...
                  clonedResponse.text().then(function (body) {
                    var matched = false;
                    var origin = AjaxTap.url(response.url).origin;
                    _this.responseEvents.forEach(function (e) {
                      if (!matched) {
                        ...
                        if (e.trustedMessengers.some(function (messenger) {
                          ...
                          var contentType = response.headers.get('content-type') || response.headers.get('Content-Type');
                          var data = null;
